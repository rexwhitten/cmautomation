...
def import_aws_logic(event, context):
    """
    Logic for importing AWS security posture data.
    ...
    # S3 key structure: data/import_aws/{run_id}/data.json
    s3_key = f"data/import_aws/{run_id}/data.json"
    ...
    try:
        ...
        return {
            ...
            "body": json.dumps(
                {
                    "error": "Failed to import AWS data",
                    "details": str(e),
