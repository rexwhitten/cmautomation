...
def import_azure_logic(event, context):
    """
    Logic for importing Azure security posture data.
    ...
    # S3 key structure: data/import_azure/{run_id}/data.json
    s3_key = f"data/import_azure/{run_id}/data.json"
