...
def import_wiz_logic(event, context):
    """
    Logic for importing Wiz security posture data.
    ...
    # S3 key structure: data/import_wiz/{run_id}/data.json
    s3_key = f"data/import_wiz/{run_id}/data.json"
    ...
    try:
        ...
        return {
            ...
            "body": json.dumps(
                {
                    "error": "Failed to import Wiz data",
                    "details": str(e),
